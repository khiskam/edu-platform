...
func (e CategoryEdges) LessonsOrErr() ([]*Lesson, error) {
	if e.loadedTypes[0] {
...
// QueryLessons queries the "lessons" edge of the Category entity.
func (c *Category) QueryLessons() *LessonQuery {
	return NewCategoryClient(c.config).QueryLessons(c)
}
